				...
				<section className="flex flex-col gap-16">
					...
					<section className="flex flex-col gap-6 text-slate-300 leading-relaxed">
						<p>
							...
							wherever it leads. I didn’t grow up planning to be a
							software engineer. I simply kept asking questions,
							taking things apart, trying to understand how the
							world works, and slowly I found myself here —
							building systems, writing code, and learning every
							day.
						</p>

						<p>
							What keeps me in this field is not the technology
							itself, but the thinking behind it. I enjoy the
							quiet work of making something clearer than it was
							before, of turning complexity into something usable,
							and of being responsible for the things I put into
							the world.
						</p>
					</section>
					...
					<section className="flex flex-col gap-6 text-slate-300 leading-relaxed">
						<p>
							...
							help me understand people — including myself — with
							more patience and honesty. Running and hiking give
							me a sense of grounding, and reading reminds me how
							large and varied the world really is.
						</p>

						<p>
							These days, I’m trying to grow in quiet ways:
							becoming a better listener, a more thoughtful
							engineer, and someone who chooses his work and his
							life more carefully than before.
						</p>
					</section>
